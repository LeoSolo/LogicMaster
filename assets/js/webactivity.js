...
localStorage.removeItem = function(key) {
	...
	if (JSAPI && typeof JSAPI.bridge != "undefined") JSAPI.bridge("removeLocalStorageKey");
...
Storage.prototype.setItem = function(key, value) {
	...
	if (JSAPI && typeof JSAPI.bridge != "undefined") JSAPI.bridge("localStorageSetItem");
...
/*Storage.prototype.getItem = function(key) {
	...
	if (JSAPI && typeof JSAPI.bridge != "undefined") return JSAPI.bridge("localStorageGetItem");
	return localStorage[key];
}*/

Storage.prototype.getKeys = function() {
	if (typeof MyJS != "undefined") return JSON.parse(MyJS.getLocalStorageKeys());
	if (JSAPI && typeof JSAPI.bridge != "undefined") return JSON.parse(JSAPI.bridge("getLocalStorageKeys")).keys;
	...
	if (platform == "android") {
		...
		(function() {
			JSAPI = function() {
				...
				this.forceShowAd = function() {
					console.log("JSAPI: forceShowAd() unavailable on Android.");
				}

				this.isVideoLoaded = function() {
					console.log("JSAPI: isVideoLoaded() unavailable on Android.");
				}
		...
		(function() {
			JSAPI = function() {
				this.console = true;
				this.updateTempStat = function() {
					if (this.console) console.log("JSAPI: updateTempStat() invoked.");
					if (typeof MyJS != "undefined") MyJS.updateTempStat();
				}
				this.test = function() {
				...
				this.forceShowAd = function() {
					if (this.console) console.log("JSAPI: forceShowAd() invoked.");
					if (typeof MyJS != "undefined") MyJS.forceShowAd();
				}

				this.isVideoLoaded = function() {
					if (this.console) console.log("JSAPI: isVideoLoaded() invoked.");
					if (typeof MyJS != "undefined") var result = MyJS.isVideoLoaded();
				...
				this.isNetworkEnabled = function() {
					if (this.console) console.log("JSAPI: isNetworkEnabled() invoked.");
					if (typeof MyJS != "undefined") var result = MyJS.isNetworkEnabled();

					return (result == "true") ? true : false;
				}

				this.getActiveNetworkList = function() {
					if (this.console) console.log("JSAPI: getActiveNetworkList() invoked.");
					if (typeof MyJS != "undefined") {
						var result = MyJS.getActiveNetworkList();
